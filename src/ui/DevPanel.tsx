...
export function DevPanel() {
  ...
  const values = useControls({
    ...
    Particles: folder({
      visualMode:          { value: 'hybrid', options: ['fluid', 'streamlines', 'hybrid', 'electric', 'neon', 'nova', 'formula', 'feather'], label: 'Visual mode (V)' },
  ...
  useEffect(() => {
    setDevParams({
      ...values,
      visualMode: values.visualMode as 'fluid' | 'streamlines' | 'hybrid' | 'electric' | 'neon' | 'nova' | 'formula' | 'feather',
    })
  }, [values, setDevParams])
